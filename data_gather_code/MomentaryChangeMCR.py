...
# However, instead of the previous version of this manipulation, this version
# instead of introducing a continuous MCR change, will only change the MCR at either a single
# moment or for some small interval
...
def skew(iterations, anom_start=0, anom_end=1, anom_config=None):
    ...
    filename = f'MCRTest_{timestamp}.csv'
    ...
    with open(filename, mode='w', newline='') as file:
        ...
        while iteration < iterations:
            ...
            if anom_start != 0 and anom_start <= iteration <= anom_end :
                if anom_config:
